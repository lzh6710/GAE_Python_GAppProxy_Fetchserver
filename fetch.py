...
class MainHandler(webapp.RequestHandler):
    ...
    Fetch_Max = 3
    spammer_list = ["207.226.143.112","54.92.72.114"]
...
<html>
    ...
    <body>
        <table width="800" border="0" align="center">
            ...
            <tr><td align="center">
                GAppProxy 是一個開源的HTTP Proxy軟件,使用Python編寫,運行於Google App Engine平台上. 
            </td></tr>
            <tr><td align="center"><hr></td></tr>

            <tr><td align="center">
                更多相關介紹,請參考<a href="http://gappproxy.googlecode.com/">GAppProxy項目主頁</a>. 
            </td></tr>
            <tr><td align="center"><hr></td></tr>
