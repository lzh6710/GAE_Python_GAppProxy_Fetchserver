...
'''<html>
    <head>
        ...
        <title>GAppProxy 熱門站點統計</title>
    </head>
    <body>
        <table width="800" border="1" align="center">
            <tr><th colspan="2">GAppProxy 熱門站點統計（TOP %d）</th></tr>
            <tr><th>站點</th><th>訪問量</th></tr>
''' % count)
...
'''<html>
    <head>
        <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
        <title>GAppProxy 用戶使用統計</title>
    </head>
    <body>
        <table width="800" border="1" align="center">
            <tr><th colspan="2">GAppProxy 用戶使用統計（TOP %d）</th></tr>
            <tr><th>用戶 IP</th><th>訪問量</th></tr>
''' % count)
